...
a=requests.get("https://github.com/approvedm/approved.txt").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    print("Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('xdg-open https://t.me/a')
    exit()
...
'  ██   █ █ █ █',        
   '  ██   █     █',
  '  ██   █     █',
' TYPE 2 THEN CLICK KEYBOARD ENTER BUTTON THEN TYPE 5 THEN TYPE python add.py AND CLICK ENTER BUTTON',

    ]
    for char in b:
        print(f'{random.choice(colors)}{char}{n}')
    #print('=============SON OF GENISYS==============')
    print(f'   Version: 1.3 | Author: @PROMOTER_BOSS_70K{n}\n')
...
while True:
    ...
    print(lg+'[4] Update your @PROMOTER_BOSS_70K'+n)
    print(lg+'[5] Quit'+n)
    a = int(input('\nEnter your choice: '))
    if a == 1:
        new_accs = []
            ...
            for account in accounts:
                ...
                if not client.is_user_authorized():
                    try:
                        ...
                        print(r+str(phone) + ' is banned answer by @PROMOTER_BOSS_70K!'+n)
                        banned_accs.append(account)
            if len(banned_accs) == 0:
                print(lg+'Congrats! No banned accounts answer by @PROMOTER_BOSS_70K')
                input('\nPress enter to goto main menu...')
            else:
                ...
                with open('vars.txt', 'wb') as k:
                    for a in accounts:
                        ...
                        pickle.dump([Phone], k)
                k.close()
                print(lg+'[i] All banned accounts removed answer by @PROMOTER_BOSS_70K'+n)
                input('\nPress enter to goto main menu...')
        ...
        if float(version.text) > 1.1:
            ...
            print(f'{lg}[i] Your tmpromoter70kadder is already up to date')
            input('Press enter to goto main menu...')
    elif a == 5:
        clr()
        banner()
